...
public class LevelGrid : MonoBehaviour
{
    ...
    [SerializeField] private GameObject gridDebugObjectPrefabParent;
    [SerializeField] private bool spawnGridDebugObjects;
    [SerializeField] private bool spawnGridDebugLines;
    ...
    private void Awake()
    {
        ...
        {
            gridSystem.CreateDebugObjects(gridDebugObjectPrefab, gridDebugObjectPrefabParent);
        }

        if (spawnGridDebugLines)
        {
            gridSystem.CreateDebugLines();
        }
    ...
    public float GetCellSize() => GetGridSystem().GetCellSize();
